...
The implementation supports fixed, learned, and minibatch-profiled precision.
The last option inserts $\beta^\star=Bd/(2\sum_\mu E_\mu)$ separately in each
...
Confirmatory noiseless and overcomplete experiments must therefore compare
this exploratory choice with a fixed or properly regularized learned
precision.
...
The planned full-mode development defaults use five seeds, batch size 256, learning rate
$3\times10^{-4}$, 65,536 normalization samples, 256,000 online training
samples, and 100,000 evaluation samples.  It is an exploratory precursor to
the official 200-million-sample training protocol, and it excludes profiled
precision for VG-SAE\@.
