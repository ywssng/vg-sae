...
atom 선택·수렴 결정·threshold 결정에 쓰지 않는다.
...
개입 효과로 별도 보고한다. 동일 atom이 남는 것 자체는 양성 기준이 아니다.

### B2: duplicate-invariant primary semantic endpoint
...
native threshold .5가 primary다. 추가로 cal에서 true 평균 support count에
...
의존하는 feature-recovery 손상'을 지지한다고 본다. 역시3 data world 모두의
