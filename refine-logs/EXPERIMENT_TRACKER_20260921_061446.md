# Experiment Tracker — VG-SAE 후속 wave 초안

작성일: 2026-09-21. 기준: 같은 폴더의 `experiment-plan-draft.md`.
...
| SELECT-B1 | M1/M2 | cap별 control+checkpoint 및 non-VG reference 동결 | cal only; 최대 108 primary test rows | 36 primary method/world/condition 선택 + secondary caps | MUST | TODO | 평균 5% error 감소, F1와 seed reversal guardrails |
...
| B2-W101 | M3 | 위와 같음 | exponential101 | 신규18 / 72 | MUST | TODO | m/a·mean/stochastic/hard metrics |
...
성패와 이유를 연결한다. 기존 산출물 삭제나 canonical 파일 덮어쓰기는 이 draft 작업 범위에 없다.
