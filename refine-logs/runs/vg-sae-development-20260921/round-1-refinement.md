...
- **C2:** 현재 parameterization 안에서 full VG objective의 variance와 entropy가
  support–amplitude 결합과 유용한 hard code를 유지하는 데 기여한다.
  같은 architecture에서 항을 제거하고 m/a scale과 세 readout risk를 검사한다.
  이 내부 주장은 미검증이다. 추가 encoder capacity와 무관한 확률 방법 전반의
